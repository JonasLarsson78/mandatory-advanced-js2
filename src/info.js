            ...
            <table className="infoTabel">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td className="rateTd"><b>Rating: </b>
                            <Rater total={5} interactive={false} rating={Number(data.rating)}/>
                            ({data.rating}) 
                            <Link to={"/edit/" + data.id}>
                            <button style={{position: "absolute", right: "10px", bottom: "27px"}} className="btn">
                            <span>Edit</span>
                            </button>
                            </Link>
                         </td>
